...
**ANEKS-3B-4 (2026-07-27):** F2 dezaktywowane na stale (ustalenie F-3b-2: pixel-IoU nieadekwatny dla dolotu, R3 741/133 legalnych odrzucen); czysty test F3 (r4) na przepisie S3b2-R; wg ANEKS_3B4_CZYSTY_TEST_F3.md.
**ANEKS-3B-5 (2026-07-27):** naprawa selekcji checkpointu (F-3b-3) — walidacja = stratyfikowany held-out 8%/runda z pelnego agregatu (seed splitu 45021); Z2 hover-rich BC (47200-47299) nieaktywne; wg ANEKS_3B5_SELEKCJA.md.
**ANEKS-3B-6 (2026-07-28):** hover-rich BC AKTYWNE — BC 400 = 300 std + 100 hover-rich (47200-47299; szybki najazd v_max=2/t_ramp=0.5, trzyma zawis; cel: kubelek B4); przepis S3b2-R + Z1 + ROUNDS=3; wg ANEKS_3B6_HOVER_RICH.md.
**ANEKS-3B-7 (2026-07-28):** kurikulum GT+live AKTYWNE — BC 400 = 300 live + 100 GT-fed (47300-47399, box=gt_bbox_256, ekspert std); hover-rich OFF; KLAUZULA KONCA (ostatnia iteracja precondition w mandacie: FAIL -> granica przy nietknietym progu, sweep czysty, przejscie do G2/3c); wg ANEKS_3B7_KURIKULUM.md.
